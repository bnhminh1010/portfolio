...
export function ArrowRoll({ className = "", size = "md" }: ArrowRollProps) {
  ...
  return (
    <span
      className={`relative overflow-hidden rounded-[2px] bg-black text-white group-hover:bg-white group-hover:text-black flex items-center justify-center font-extrabold shrink-0 transition-colors duration-300 select-none ${sizeClasses} ${className}`}
    >
