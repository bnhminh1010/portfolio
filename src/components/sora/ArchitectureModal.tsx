      ...
      {projectId && (
        ...
        >
          <motion.div
            ...
            className="w-full max-w-5xl bg-[#0c0c0e] border border-white/[0.1] rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh] cursor-default"
          >
            {/* Header */}
            <div className="px-6 py-4 bg-[#141417] border-b border-white/[0.08] flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-mono uppercase px-2 py-0.5 rounded bg-white/[0.06] border border-white/[0.08] text-neutral-300">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="p-1.5 rounded-lg bg-white/[0.04] hover:bg-white/[0.1] text-neutral-400 hover:text-white transition-colors cursor-pointer"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
                  ...
                  {isHomelab ? (
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-2">
                        {/* Column 1: Ingress */}
                        <div className="p-4 bg-[#141418] border border-white/[0.08] rounded-xl space-y-3">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-5 gap-3 pt-2">
                        {[
                          ...
                          <div key={s.step} className="p-3 bg-[#141418] border border-white/[0.08] rounded-xl space-y-1">
              ...
              {activeTab === "security" && (
                <div className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="p-4 bg-[#141418] border border-white/[0.08] rounded-xl space-y-2">
                ...
                <div className="space-y-4">
                  <div className="space-y-3">
                    {project.evidence.repository.map((item, idx) => (
                      <div key={idx} className="p-4 bg-[#141418] border border-white/[0.08] rounded-xl flex items-center justify-between gap-4">
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="px-3 py-1.5 rounded bg-white/[0.06] hover:bg-white/[0.12] text-xs font-mono text-white flex items-center gap-1.5 transition-colors whitespace-nowrap"
                        >
