  ...
  return (
    ...
    >
      ...
      <div className="px-4 sm:px-5 py-3 border-b border-white/[0.1] bg-[#0c0c0e]/95 backdrop-blur-md flex items-center justify-between gap-3 select-none">
        ...
        <div className="flex-1 max-w-sm mx-auto">
          ...
          >
            ...
            <ArrowUpRight className="w-3 h-3 text-neutral-500 group-hover/url:text-white shrink-0 ml-0.5 transition-colors" />
          </a>
        </div>
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="relative w-full aspect-[16/10] overflow-hidden bg-[#09090c] block cursor-pointer group/viewport"
      ...
      >
        ...
        <div
          className="absolute inset-0 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-700 bg-gradient-to-tr from-transparent via-white/[0.05] to-transparent"
        />
      ...
      <div className="px-4 sm:px-5 py-2.5 border-t border-white/[0.1] bg-[#0c0c0e]/95 backdrop-blur-md flex items-center justify-between text-[11px] font-mono text-neutral-400 select-none">
        <div className="flex items-center gap-2">
          <ShieldCheck className="w-3.5 h-3.5 text-emerald-400" />
          <span className="text-neutral-200 font-bold uppercase tracking-wider text-[10.5px]">
            {type === "homelab" ? "HOMELAB V4 · GITOPS DEPLOYED" : "PRODUCTION ACTIVE · SAST VERIFIED"}
          </span>
        </div>
        <div className="flex items-center gap-3 text-[10.5px] text-neutral-400 font-mono">
