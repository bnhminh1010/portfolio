...
export default function SoraPreviewPage() {
  ...
  return (
    <div className="sora-studio-root selection:bg-white selection:text-black relative min-h-screen">
      ...
      >
        <div className="max-w-6xl mx-auto space-y-7 pointer-events-auto">
          {/* High-Contrast Eyebrow Badge */}
          <div className="inline-flex items-center justify-center gap-2.5 px-4 py-2 rounded-[4px] bg-black/50 border border-white/20 backdrop-blur-md text-xs font-mono font-bold tracking-[0.25em] text-white shadow-2xl leading-none">
            <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse shrink-0" />
            <span className="inline-flex items-center leading-none">DEVOPS & SYSTEMS ENGINEER · THINKAI STUDIO</span>
          </div>

          {/* Huge Solid Masked Line Reveal Headline */}
          <div className="py-2">
            <MaskedTextReveal
              as="h1"
              text={"RELIABLE\nDELIVERY"}
